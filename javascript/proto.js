...
// const obj = new ReverseString("Laksh");

// console.log("Original :", obj.str);
// console.log("Reverse  :", obj.reverse());
...
//     console.log(`The reversed is${thsi.split("").reverse().join("")}`);
// };
// str;
// console.log(Objext().__proto__);

// String.prototype.transform=function(separtor){
//     console.log(`the reversed is ${this.split(separtor)}`)
// }
